    ...
    >
      ...
      >
        ...
        {badgeCount !== undefined && badgeCount > 0 && (
          <motion.span
            ...
            className="absolute -top-1 -right-1 h-4 w-4 rounded-full bg-brand-red text-white text-[10px] font-bold flex items-center justify-center"
          >
      ...
      {isActive && (
        <motion.div
          ...
          className="absolute bottom-0 h-0.5 w-8 rounded-full bg-brand-green"
