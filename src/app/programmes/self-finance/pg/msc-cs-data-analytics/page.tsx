...
import { BookOpen, Users, Award, Briefcase, Library, GraduationCap, Building2, Lightbulb, CheckCircle2, Clock, FileText, Globe, ChevronDown, ArrowRight, Sparkles, Target, Code, Cpu, Database, Brain, BarChart3, Cloud } from 'lucide-react';
...
export default function MScCSDataAnalyticsPage() {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                { icon: <Cloud className="w-6 h-6" />, title: 'Data Scientist', desc: 'Build predictive models and derive insights at tech giants and startups' },
                ...
                { icon: <Database className="w-6 h-6" />, title: 'Data Engineer', desc: 'Build robust data pipelines and infrastructure' },
      ...
      <section className="py-16 bg-white" id="facilities">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: 'High-Performance Computing Lab', description: 'GPU-powered workstations with NVIDIA Tesla cards, 128GB RAM systems, and high-speed SSD storage for deep learning and big data processing.', image: 'https://placehold.co/400x200/0b6d41/FFFFFF?text=Data+Science+Lab' },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <Marquee pauseOnHover draggable speed={30} className="[--gap:1.5rem]">
              {[
                { name: 'Dr. Rajesh Kumar', designation: 'Head of Department', qualification: 'Ph.D. in Data Science & ML' },
                { name: 'Dr. Priya Shankar', designation: 'Associate Professor', qualification: 'Ph.D. in Artificial Intelligence' },
                { name: 'Mr. Arun Prakash', designation: 'Assistant Professor', qualification: 'M.Tech in Big Data Analytics' },
                { name: 'Ms. Kavitha Raman', designation: 'Assistant Professor', qualification: 'M.Sc CS, Data Science Specialist' }
              ].map((faculty, idx) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'What is the average salary for M.Sc Data Analytics graduates?', answer: 'Entry-level Data Analyst positions typically offer packages ranging from ₹4.5 to ₹8 lakhs per annum. With specialization in Machine Learning or AI, packages can range from ₹8-15 lakhs. Senior data scientists and ML engineers can command ₹15-35+ lakhs per annum depending on skills and experience.' },
          ...
          <div className="max-w-6xl mx-auto">
            <RevealSection>
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600">
                  Discover other computer science and technology programmes at our college
                </p>
              </div>
            </RevealSection>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { title: 'B.Sc Computer Science', description: 'Comprehensive undergraduate programme in computer science fundamentals', duration: '3 Years', image: 'https://placehold.co/400x180/0b6d41/FFFFFF?text=BSc+CS' },
                ...
                { title: 'B.Sc Mathematics', description: 'Advanced mathematics with computational and analytical focus', duration: '3 Years', image: 'https://placehold.co/400x180/0b6d41/FFFFFF?text=BSc+Maths' }
              ].map((programme, idx) => (
                <RevealSection key={idx} delay={idx * 150}>
